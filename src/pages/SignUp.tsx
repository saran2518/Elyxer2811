...
const Legal = ({ onOpen }: { onOpen: (doc: LegalDoc) => void }) => {
  ...
  return (
    <p className="font-inter text-[13px] leading-relaxed text-white/90 text-center px-2">
          ...
          <AnimatePresence mode="wait">
            {!showOptions ? (
              ...
              >
                ...
                <button
                  onClick={() => setShowOptions(true)}
                  className="font-inter text-white text-[16px] font-medium text-center"
                >
                  Sign in
                </button>
              </motion.div>
              ...
              >
                ...
                <button
                  ...
                  className="font-inter text-white text-[16px] font-medium text-center mt-2"
                >
                  Back
                </button>
                <Legal onOpen={setLegalDoc} />
