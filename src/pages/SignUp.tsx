      ...
      <div className="relative z-10 flex min-h-screen flex-col px-6 pt-16 pb-8">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "'Marcellus SC', serif", fontWeight: 400, letterSpacing: "0.12em", fontStyle: "normal", backgroundImage: "linear-gradient(135deg, #FFFFFF 0%, #F5F5F5 50%, #E8E8E8 100%)" }}
          >
