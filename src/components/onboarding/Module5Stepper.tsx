...
import { Ruler, Languages, Image as ImageIcon, CheckCircle } from "lucide-react";
...
interface Module5StepperProps {
  currentStep: number;
  progressPercent: string;
  doneActive?: boolean;
}

const Module5Stepper = ({ currentStep, progressPercent, doneActive }: Module5StepperProps) => (
  <motion.div
    initial={{ opacity: 0 }}
    animate={{ opacity: 1 }}
