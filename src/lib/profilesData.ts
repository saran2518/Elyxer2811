...
export const PROFILES: ProfileData[] = [
  ...
  },
  {
    ...
    specialization: "Coral Restoration",
    ...
    interests: ["Scuba diving", "Ocean conservation", "Documentaries", "Beach runs", "Photography", "Sustainability"],
    relationshipIntent: ["Shared Experiences", "Discovery Mode"],
    bio: "I spend more time underwater than on land, restoring coral reefs and documenting marine life. When I'm back on shore, I love long beach runs, salty sunsets, and conversations about the future of our oceans.",
    narratives: [
      { title: "Beneath the Surface", content: "The ocean taught me patience — some reefs take decades to heal, but every small effort matters." },
      { title: "Coastal Roots", content: "Growing up between two coasts gave me a lifelong love for the sea and everyone who calls it home." },
    ],
    joinMeFor: [
      "Sunrise scuba dive along the reef",
      "Beach cleanup followed by filter coffee",
      "A documentary night about ocean life",
    ],
    photos: [profilePhoto4, profilePhoto5, profilePhoto6, profileImage],
  },
];
